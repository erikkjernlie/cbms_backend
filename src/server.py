...
from src.database import views as database_views
from src.topics import views as topics_views
from src.configuration import views as configuration_views
...
def init_app(settings) -> web.Application:
    ...
    app.router.add_routes(topics_views.routes)
    app.router.add_routes(processor_views.routes)
    app.router.add_routes(blueprints_views.routes)
    app.router.add_routes(configuration_views.routes)
    app.router.add_routes(database_views.routes)
